...
public class Query implements GraphQLQueryResolver {
  ...
  private final InfrastructureRepository InfrastructureRepositoryInstance;

  public Query(MetroAndBusStopRepository MetroAndBusStopRepositoryInstance, SuburbRepository SuburbRepositoryInstance, GeographicalCoordinateRepository GeographicalCoordinateRepositoryInstance, BicingStationRepository BicingStationRepositoryInstance, DistrictRepository DistrictRepositoryInstance, InfrastructureRepository InfrastructureRepositoryInstance) {
    ...
    this.InfrastructureRepositoryInstance = InfrastructureRepositoryInstance;
  }
  ...
  public List<IInfrastructure> allInfrastructures() {
    return InfrastructureRepositoryInstance.getAllInfrastructures();
  }

  public IInfrastructure getInfrastructure(String id) {
    return InfrastructureRepositoryInstance.getInfrastructure(id);
  }
}
